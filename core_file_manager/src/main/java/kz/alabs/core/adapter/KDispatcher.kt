 ...
 */
inline fun <reified T : Any> IDispatcher.subscribe(
    notificationName: String?,
    priority: Int? = null,
    noinline sub: Subscriber<T>
) {
 ...
 */
inline fun <reified T : Any> IDispatcher.unsubscribe(
    notificationName: String?,
    noinline sub: Subscriber<T>? = null
) {
 ...
 */
inline fun <reified T : Any> IKDispatcher.subscribe(
    notif: String?,
    priority: Int? = null,
    noinline sub: Subscriber<T>
): IKDispatcher {
 ...
 */
inline fun <reified T : Any> IKDispatcher.subscribeList(
    notifs: List<String>,
    priority: Int? = null,
    noinline sub: Subscriber<T>
): IKDispatcher {
